 ...
 * {@link #insertNode(String, ConceptualBTNodeItem)}, that is used to insert
 * nodes (CategoryItem and NodeItem) into the tree.
 * <p>
...
public class ConceptualNodesTree {
    ...
    /**
     * Inserts a NodesTreeItem into the tree, at a particular position. The
     * position is specified by the <code>category</code> parameter. This
     * parameter is a String representing the category where the NodeItem must
     * be inserted.
     * <p>
